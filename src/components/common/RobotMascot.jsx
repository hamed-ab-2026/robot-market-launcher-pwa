...
/**
 * لوگوی SVG ربات را بدون وابستگی به فایل تصویری خارجی رندر می‌کند.
 * variant تعیین می‌کند نسخه کوچک لوگو یا تصویر کامل نمایش داده شود و className اندازه و چیدمان را کنترل می‌کند.
 */
