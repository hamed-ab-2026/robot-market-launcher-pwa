...
export default function AuthPage() {
    ...
    return (
        <div
            className="relative flex min-h-screen flex-col overflow-hidden bg-gradient-to-b from-surface-light to-brand-50 dark:from-surface-dark dark:to-slate-900">
            {}
            <svg
            ...
            <main className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 pb-10">
                <RobotMascot variant="logo-RobotMarket" className="mb-4 h-20 w-60 animate-fade-in"/>
                ...
                {showBiometricButton &&
                    <button
                        ...
                        <span
                            className="flex h-14 w-14 items-center justify-center rounded-full bg-brand-50 text-2xl text-brand-500 ring-2 ring-brand-100 dark:bg-brand-900/30 dark:ring-brand-800">
                          <FingerprintIcon/>
                        </span>
