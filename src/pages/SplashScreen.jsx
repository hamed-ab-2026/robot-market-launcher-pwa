...
/**
 * صفحه شروع کوتاه برنامه را همراه با برند و نشانگر بارگذاری نمایش می‌دهد.
 * زمان پایان این صفحه در Router کنترل می‌شود تا این کامپوننت فقط مسئول ظاهر باقی بماند.
 */
